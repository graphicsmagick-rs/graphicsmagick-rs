...
use graphicsmagick_sys::{
    AffineMatrix, MagickCloneDrawingWand, MagickDestroyDrawingWand, MagickDrawAffine,
    MagickDrawAnnotation, MagickDrawArc, MagickDrawBezier, MagickDrawCircle, MagickDrawColor,
    MagickDrawComment, MagickDrawEllipse, MagickDrawGetClipPath, MagickDrawGetClipRule,
    MagickDrawGetClipUnits, MagickDrawGetFillColor, MagickDrawGetFillOpacity,
    MagickDrawGetFillRule, MagickDrawGetFont, MagickDrawGetFontFamily, MagickDrawGetFontSize,
    MagickDrawGetFontStretch, MagickDrawGetFontStyle, MagickDrawGetFontWeight,
    MagickDrawGetGravity, MagickDrawGetStrokeAntialias, MagickDrawGetStrokeColor,
    MagickDrawGetStrokeDashArray, MagickDrawGetStrokeDashOffset, MagickDrawGetStrokeLineCap,
    MagickDrawGetStrokeLineJoin, MagickDrawGetStrokeMiterLimit, MagickDrawGetStrokeOpacity,
    MagickDrawGetStrokeWidth, MagickDrawGetTextAntialias, MagickDrawGetTextDecoration,
    MagickDrawGetTextEncoding, MagickDrawGetTextUnderColor, MagickDrawLine, MagickDrawMatte,
    MagickDrawPathClose, MagickDrawPathCurveToAbsolute,
    MagickDrawPathCurveToQuadraticBezierAbsolute, MagickDrawPathCurveToQuadraticBezierRelative,
    MagickDrawPathCurveToQuadraticBezierSmoothAbsolute,
    MagickDrawPathCurveToQuadraticBezierSmoothRelative, MagickDrawPathCurveToRelative,
    MagickDrawPathCurveToSmoothAbsolute, MagickDrawPathCurveToSmoothRelative,
    MagickDrawPathEllipticArcAbsolute, MagickDrawPathEllipticArcRelative, MagickDrawPathFinish,
    MagickDrawPathLineToAbsolute, MagickDrawPathLineToHorizontalAbsolute,
    MagickDrawPathLineToHorizontalRelative, MagickDrawPathLineToRelative,
    MagickDrawPathLineToVerticalAbsolute, MagickDrawPathLineToVerticalRelative,
    MagickDrawPathMoveToAbsolute, MagickDrawPathMoveToRelative, MagickDrawPathStart,
    MagickDrawPoint, MagickDrawPolygon, MagickDrawPolyline, MagickDrawPopClipPath,
    MagickDrawPopDefs, MagickDrawPopGraphicContext, MagickDrawPopPattern, MagickDrawPushClipPath,
    MagickDrawPushDefs, MagickDrawPushGraphicContext, MagickDrawPushPattern, MagickDrawRectangle,
    MagickDrawRotate, MagickDrawRoundRectangle, MagickDrawScale, MagickDrawSetClipPath,
    MagickDrawSetClipRule, MagickDrawSetClipUnits, MagickDrawSetFillColor,
    MagickDrawSetFillOpacity, MagickDrawSetFillPatternURL, MagickDrawSetFillRule,
    MagickDrawSetFont, MagickDrawSetFontFamily, MagickDrawSetFontSize, MagickDrawSetFontStretch,
    MagickDrawSetFontStyle, MagickDrawSetFontWeight, MagickDrawSetGravity,
    MagickDrawSetStrokeAntialias, MagickDrawSetStrokeColor, MagickDrawSetStrokeDashArray,
    MagickDrawSetStrokeDashOffset, MagickDrawSetStrokeLineCap, MagickDrawSetStrokeLineJoin,
    MagickDrawSetStrokeMiterLimit, MagickDrawSetStrokeOpacity, MagickDrawSetStrokePatternURL,
    MagickDrawSetStrokeWidth, MagickDrawSetTextAntialias, MagickDrawSetTextDecoration,
    MagickDrawSetTextEncoding, MagickDrawSetTextUnderColor, MagickDrawSetViewbox, MagickDrawSkewX,
    MagickDrawSkewY, MagickDrawTranslate, MagickNewDrawingWand, PointInfo,
};
use std::{

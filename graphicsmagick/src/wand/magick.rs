...
use graphicsmagick_sys::{
    ...
    MagickGetVersion, MagickHaldClutImage, MagickHasColormap, MagickHasNextImage,
    MagickHasPreviousImage, MagickImplodeImage, MagickIsGrayImage, MagickIsMonochromeImage,
    MagickIsOpaqueImage, MagickIsPaletteImage, MagickLabelImage, MagickLevelImage,
    MagickLevelImageChannel, MagickMagnifyImage, MagickMapImage, MagickMatteFloodfillImage,
    MagickMedianFilterImage, MagickMinifyImage, MagickModulateImage, MagickMontageImage,
    MagickMorphImages, MagickMosaicImages, MagickMotionBlurImage, MagickNegateImage,
    MagickNegateImageChannel, MagickNextImage, MagickNormalizeImage, MagickOilPaintImage,
    MagickOpaqueImage, MagickPass, MagickPingImage, MagickPreviewImages, MagickPreviousImage,
    ...
    MagickSetPassphrase, MagickSetResolution, MagickSetResolutionUnits, MagickSetResourceLimit,
    MagickSetSamplingFactors, MagickSetSize, MagickSharpenImage, MagickShaveImage,
    MagickShearImage, MagickSolarizeImage, MagickSpreadImage, MagickSteganoImage,
    MagickStereoImage, MagickStripImage, MagickSwirlImage, MagickTextureImage,
